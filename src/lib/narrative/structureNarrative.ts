...
// ============================================================
import { CHUNG_BASE_COPY, GRAIN_MODIFIER, type ChungName, type GrainCode } from "@/content/jadeContent";
...
export function generateStructureNarrative(chung: ChungName, grain: GrainCode | undefined): string {
  ...
  // thay vì throw, vì đây là lỗi dữ liệu upstream (đã được chặn ở
  // classifyChung trả null trước khi tới đây), không phải lỗi content.
